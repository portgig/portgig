...
const WelcomeOnboarding = () => {
  return (
    <main className=" ">
      ...
      <div className="flex flex-col gap-10 lg:gap-20 justify-center items-center max-lg:bg-white max-lg:text-primary mx-3 md:mx-10 rounded-3xl px-5 md:px-10 py-20 xl:w-8/12 lg:mx-auto">
        <h2 className="font-bold text-2xl md:text-3xltext-center">Welcome</h2>
        <p className="leading-10 text-center text-sm md:text-xl font-bold ">
